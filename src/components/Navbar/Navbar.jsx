...
const Navbar = () => {
  ...
  return (
    <nav className="  xl:w-[1800px]  w-full mx-auto md:fixed top-0 left-0 right-0 z-50 py-[15px] shadow-sm ">
      <div className=" px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 navbardiv">
          <div className="flex items-center">
            <div className="flex-shrink-0">
              <Link to="/"  className=" font-semibold md:text-[35px] ">
                Firoj Hasan
              </Link>
            </div>
          </div>
          <div className="hidden lg:block">
            ...
            <label className="swap swap-rotate">
              ...
              <Link
                ...
                className=" hover:bg-gray-700 hover:text-white px-3 text py-2 rounded-md text-[20px] font-medium  cursor-pointer"
              >
                About
              </Link>
              <Link
